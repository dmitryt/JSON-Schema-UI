    ...
    .directive(ID, [
        function() {
            return {
                restrict: "E",
                replace: true,
                templateUrl: "/schema/fields/edit/textarea/textarea.html"
            }
        }
    ]);
})();
...
angular.module('adstreamJsonSchemaUI').run(['$templateCache', function($templateCache) {

  $templateCache.put('/schema/form/form.html', '<div class="b-schema-form">\n    <scm-form-group groups="groups" data="data" group="group" ng-repeat="group in groups | orderBy: \'order\'"></scm-form-group>\n</div>');

  $templateCache.put('/schema/form/group/group.html', '<div class="b-schema-form-group">\n    <div class="b-schema-form-group__title" ng-if="group.description">{{ group.description }}</div>\n    <div class="b-schema-form-group__content b-schema-fields clearfix">\n    	<scm-fields-edit data="data" field="field" ng-repeat="field in group.fields"></scm-fields-edit>\n    </div>\n</div>');

  $templateCache.put('/schema/fields/edit/array/array.html', '<div class="b-schema-fields--edit__array">\n    <scm-fields-edit-array-item ng-repeat="v in values" data="v" field="field">\n		<div class="b-schema-fields--edit__array-item__panel">\n	        <div class="glyphicon glyphicon-trash" ng-click="onRemove($index)"></div>\n	        <div class="glyphicon glyphicon-plus" ng-click="onAdd()" ng-if="$first"></div>\n	    </div>\n	</scm-fields-edit-array-item>\n</div>\n');

  $templateCache.put('/schema/fields/edit/checkbox/checkbox.html', '<div class="b-schema-fields--edit__checkbox">\n    <label class="m-field__label">\n    	<input type="checkbox" ng-model scm-fields-edit-formatter class="ui-input valign-middle"/>\n    	<span ng-class="{\'s-required\': field.required}" ng-required="field.required" class="m-field__description">{{ field.description }}</span>\n    </label>\n</div>');

  $templateCache.put('/schema/fields/edit/date/date.html', '<div class="b-schema-fields--edit__date">\n	<label class="m-field__label">\n		<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n		<div class="b-datepicker">\n			<div class="display-table-cell">\n				<input\n				type="text"\n				class="ui-input"\n				show-button-bar="false"\n				datepicker-popup="{{ format }}"\n				ng-model scm-fields-edit-formatter\n				ng-required="field.required"\n				is-open="opened"\n				min-date="minDate"\n				datepicker-options="dateOptions"\n				close-text="Close" />\n			</div>\n			<div class="display-table-cell input-group-btn">\n				<button type="button" class="btn btn-default b-datepicker-open-btn" ng-click="open($event)">\n					<i class="spriteicon i16x16_calendar-dark"></i>\n				</button>\n			</div>\n		</div>\n	</label>\n</div>\n');

  $templateCache.put('/schema/fields/edit/email/email.html', '<div class="b-schema-fields--edit__email">\n    <label class="m-field__label">\n    	<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n    	<input type="email" ng-model scm-fields-edit-formatter ng-required="field.required" class="ui-input"/>\n    </label>\n</div>\n');

  $templateCache.put('/schema/fields/edit/enum/enum.html', '<div class="b-schema-fields--edit__enum">\n	<label class="m-field__label">\n		<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n		<ui-select ng-model scm-fields-edit-formatter theme="select2" data-width="auto" ng-disabled="fieldModel.disabled" ng-required="field.required" search-enabled="false">\n			<ui-select-match placeholder="Select or search in the list...">{{$select.selected}}</ui-select-match>\n			<ui-select-choices repeat="e in field.enum">\n				<span>{{e}}</span>\n			</ui-select-choices>\n		</ui-select>\n	</label>\n</div>');

  $templateCache.put('/schema/fields/edit/input/input.html', '<div class="b-schema-fields--edit__input">\n    <label class="m-field__label">\n    	<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n    	<input type="text" ng-model scm-fields-edit-formatter ng-required="field.required" class="ui-input"/>\n    </label>\n</div>\n');

  $templateCache.put('/schema/fields/edit/number/number.html', '<div class="b-schema-fields--edit__number">\n    <label class="m-field__label">\n    	<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n    	<input type="number" min="{{field.view.minValue}}" max="{{field.view.maxValue}}" ng-model scm-fields-edit-formatter class="ui-input" ng-required="field.required" />\n    </label>\n</div>\n');

  $templateCache.put('/schema/fields/edit/select/select.html', '<div class="b-schema-fields--edit__select">\n	<label class="m-field__label">\n		<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n		<ui-select ng-model scm-fields-edit-formatter theme="select2" data-width="auto" ng-disabled="fieldModel.disabled" ng-required="field.required" search-enabled="false">\n			<ui-select-match placeholder="Select or search in the list...">{{$select.selected.name || $select.selected.key}}</ui-select-match>\n			<ui-select-choices repeat="value in fieldModel.values">\n				<span>{{value.name || value.key}}</span>\n			</ui-select-choices>\n		</ui-select>\n	</label>\n</div>');

  $templateCache.put('/schema/fields/edit/textarea/textarea.html', '<div class="b-schema-fields--edit__textarea">\n    <label class="m-field__label">\n    	<span ng-class="{\'s-required\': field.required}" class="m-field__description">{{ field.description }}</span>\n    	<span class="m-field__hint" ng-bind-html="field.view.hint"></span>\n    	<textarea ng-model scm-fields-edit-formatter ng-required="field.required" class="ui-input"></textarea>\n    </label>\n</div>');

  $templateCache.put('/schema/fields/edit/array/item/item.html', '<div class="b-schema-fields--edit__array-item">\n    <schema-form-fields-edit ng-repeat="f in field.children | orderBy: \'order\'" ng-if="isVisible(f)" data="data" field="f"></schema-form-fields-edit>\n    <ng-transclude></ng-transclude>\n</div>');
